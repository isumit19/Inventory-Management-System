...
$userwisesql = "SELECT users.username , SUM(orders.total_amount) as totalorder FROM orders INNER JOIN users ON orders.user_id = users.user_id WHERE orders.order_status = 1 GROUP BY orders.user_id";
